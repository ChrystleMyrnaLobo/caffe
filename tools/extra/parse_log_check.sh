...
# caffe.log.test (columns: '#Iters Seconds TestLoss TestMAP TestAPCow TestAPDog TestARCow TestARDog')
# caffe.log.train (columns: 'Iters Seconds TrainLoss LearningRate')
...
## Generating .log.test file
echo "#Iters Seconds TestLoss TestMAP TestAPCow TestAPDog TestARCow TestARDog" > $LOG.test
paste aux0.txt aux4.txt aux2.txt aux1.txt ap_c2.txt ap_c1.txt ar_c2.txt ar_c1.txt | column -t >> $LOG.test
rm aux.txt aux0.txt aux1.txt aux2.txt aux3.txt aux4.txt ap_c1.txt ap_c2.txt ar_c1.txt ar_c2.txt
...
# Generating .log.train
echo 'Iters Seconds TrainLoss LearningRate'> $LOG.train
paste aux0.txt aux3.txt aux5.txt lr.txt | column -t >> $LOG.train
rm aux3.txt aux0.txt aux5.txt lr.txt 
